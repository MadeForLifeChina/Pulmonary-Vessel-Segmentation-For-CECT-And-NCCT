...
from nnunetv2.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss,DC_and_FC_loss
from nnunetv2.training.loss.deep_supervision import DeepSupervisionWrapper
from nnunetv2.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
from nnunetv2.training.loss.vessel_loss import clDC_DC_CE_clWeight_Loss
...
class nnUNetTrainer(object):
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        loss = np.mean(outputs_collated['loss'])
